...
function jch_inline_exclude_section_text()
{
        ...
        $header      = __('Exclude inline styles and inline scripts from aggregation', 'jch-optimize');
...
function jch_gen_multiselect_field($option, $values, $description, $class = '')
{
        ...
        $select .= '</select>';
        $select .= '<button type="button" onclick="addJchOption(\'jch_options_' . $option . '\')">' . __('Add item', 'jch-optimize') . '</button>';
